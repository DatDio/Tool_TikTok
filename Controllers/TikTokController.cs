    ...
    public class TikTokController
    {
        ...
        public ResultModel UpVideo(string path, DateTime _dateOneThread, ref bool clickAnotherVideo, int i)
        {
            ...
            reStart:
                ...
                {
                    //Đặt lịch
                    SeleniumHelper.Click(account.driver, By.Id("tux-3"));
                    if (SeleniumHelper.WaitElement(account.driver, By.ClassName("is-line"), 5))
                    {
                    ...
                    SeleniumHelper.Click(account.driver, By.ClassName("date-picker-input"));
                    ...
                    //click giờ,phút
                    SeleniumHelper.Click(account.driver, By.ClassName("time-picker-input"));
                    Thread.Sleep(random.Next(1000, 4000));
                    //chọn giờ
                ...
                //chọn quét bản quyền 
                Thread.Sleep(random.Next(1000, 4000));
                //SeleniumHelper.Click(account.driver, By.Id("tux-4"));
                //tiktok-loading-ring
                ...
                //bấm up video
                Thread.Sleep(random.Next(1000, 4000));
                SeleniumHelper.Click(account.driver, By.ClassName("btn-post"));
                ...
                if (Form1._rdoUpVideoTimer)
                {
                    ...
                    if (SeleniumHelper.WaitElement(account.driver, By.ClassName("is-line"), 60))
                    {
                        ...
                        if (SeleniumHelper.GetTextElement(account.driver, By.ClassName("is-line")) == "Upload another video")
                        {
                            SeleniumHelper.Click(account.driver, By.ClassName("is-line"));
                ...
                {
                    if (SeleniumHelper.WaitElement(account.driver, By.ClassName("emphasis"), 60))
                    {

                        if (SeleniumHelper.GetTextElement(account.driver, By.ClassName("emphasis")) == "Upload another video")
                        {
                            SeleniumHelper.Click(account.driver, By.ClassName("emphasis"));
                            clickAnotherVideo = true;
                            return ResultModel.Success;
                        }
